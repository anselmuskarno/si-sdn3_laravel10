...
<body class="host_version">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown-a">
                <a class="dropdown-item active" href="/agenda">Agenda </a>
  ...
  <div class="all-title-box wow fadeInLeft">
    <div class="container text-center wow fadeInUp">
      ...
      <h1>AGENDA<span class="m_1">SD Negeri 3 Toraja Utara</span></h1>
    </div>
  </div>
            ...
            <table class="table custom-table datatable">
              ...
              <tbody>
                ...
                <tr class=" bg-dark text-white">
                  ...
                  <td>{{$a->tanggal_agenda}}</td>
                  <td>{{$a->acara_agenda}}</td>
                  <td>{{$a->kegiatan_agenda}}</td>
