                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-right">
                          ...
                          <a href="/hapusSiswa/{{$s->id}}" onclick="return confirm('Apakah anda yakin data ini akan dihapus?');" type="submit" class="btn btn-danger btn-sm mb-1">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="/tambahSiswa" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                <input class="form-control" name="nisn" id="nisn" placeholder="NISN Siswa" type="text">
                                <small class="text-danger"> <i>*Tidak boleh kosong</i> </small>
                              </div>
                            </div>
                            <div class="form-group">
                          ...
                          <form action="/editSiswa/{{ $s->id }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                ...
                                <input class="form-control" value="{{ $s->nisn }}" name="nisn" id="nisn" type="text">
                                <small class="text-danger"> <i>*Tidak boleh kosong</i> </small>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                ...
                                <input class="form-control" name="password_siswa" id="password_siswa" type="text" value="{{ $s->password_siswa }}">
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                <label for="">Catatan Siswa</label>
                                <textarea class="form-control" name="catatan" id="catatan" cols="10" rows="5"> {{ $s->catatan }} </textarea>
                                <small class="text-danger"> <i>*Tidak boleh kosong</i> </small>
                              </div>
                            </div>
                        </div>
