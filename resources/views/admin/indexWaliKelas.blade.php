      ...
      <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
          ...
          <ul class="sidebar-ul">
            ...
            <li class="active">
              <a href="/halamanWaliKelas"><img src="admin/assets/img/sidebar/icon-9.png" alt="icon"><span>
                  Raport</span>
              </a>
            </li>
          </ul>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body bg-light">
                <form action="/tambahRaport" method="post">
                  @csrf
                  <input type="hidden" name="kelasku" value="{{ $kelaswali }}">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <span class="text-success">Diisi oleh sistem</span>
                          <input type="hidden" class="form-control" name="nis">
                        </div>
                      </div>
                      <div class="form-group row">
              ...
              <tr>
                ...
                <td class=" text-right d-flex">
                  ...
                  <form action="/hapusRaport" method="post">
                    ...
                    <input type="hidden" name="idraport1" value="{{ $r->id }}">
                    <input type="hidden" name="idraport2" value="{{ $idRaport2 }}">
                    <input type="hidden" value="{{ $kelaswali }}" name="kelasku">
