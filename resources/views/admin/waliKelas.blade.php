                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-right">
                          ...
                          <a href="/hapusWaliKelas/{{$a->id}}" onclick="return confirm('Apakah anda yakin data ini akan dihapus?');" type="submit" class="btn btn-danger btn-sm mb-1">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="/tambahWaliKelas" method="post" class="form-horizontal">
                            @csrf
                            <input type="hidden" name="semester" value="-">
                            <div class="form-group">
                              <div class="col-sm-12">
                                <input type="hidden" name="jabatan" value="walikelas">
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                <label for="">Jabatan/Mapel yang diajarkan</label>
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                <label for="">Wali dari kelas</label>
                  ...
                  <div class="modal fade" id="editModal{{$a->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Edit Data Wali Kelas</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                          <form action="/editWaliKelas/{{$a->id}}" method="post" class="form-horizontal">
                            @csrf
                            <input type="hidden" name="semester" value="-">
                            <div class="form-group">
                              <div class="col-sm-12">
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                <label for="">Username</label>
                                <input class="form-control" type="text" name="username" value="{{$a->username}}">
                                <small class="text-danger"> <i>*Tidak boleh kosong</i> </small>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="col-sm-12">
                                <label for="">Jabatan/Mapel yang diajarkan</label>
                                <input class="form-control" type="text" name="mapel" value="{{$a->mapel}}">
                                <small class="text-danger"> <i>*Tidak boleh kosong</i> </small>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="col-sm-12">
                                <label for="">Password</label>
                                <input class="form-control" type="text" name="password" value="{{$a->password}}">
                                <small class="text-danger"> <i>*Tidak boleh kosong</i> </small>
                              </div>
                            </div>
                            <div class="form-group">
